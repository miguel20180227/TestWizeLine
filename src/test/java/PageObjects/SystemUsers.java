...
public class SystemUsers extends BaseClass{
    ...
    public void createdUser(String userRole, String employee, String user, String statusActual, String pass) throws InterruptedException {
        ...
        WaitUntilElementClickable(btnSave);
        btnSave.isEnabled();
        Thread.sleep(1000);
        btnSave.click();
